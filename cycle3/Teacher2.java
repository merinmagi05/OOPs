...
class Employee2 extends person
{
	int Empid;
 	...
 	Employee2(String name,String gender,String address, int age,int empid, String company_name, String qualification,long salary)
 	{
...
public class Teacher2 extends Employee2
{
     	String Subject;
     	String Department;
     	String Teacherid;
    	...
    	void display()
    	{
     	...
     	public static void main(String[] args) 
     	{
        	...
        	sc.close();
        	System.out.println("********Informations of all the Teacher's************");
        	for(int i=0;i<num;i++)
        	{
            		j=i+1;
